...
github_repo: Ani-Nerf-2D
thumbnail: /images/ani_nerf_2D.gif
excerpt: A framework for developing and comparing volume deformation models, visualized with a raymarching camera. These models can then be translated to use for real-time animated NeRFs.
---
<img style="margin: 10x 0px 10px 0px;" src="/images/ani_nerf_2D.gif">
<div class="clear">
